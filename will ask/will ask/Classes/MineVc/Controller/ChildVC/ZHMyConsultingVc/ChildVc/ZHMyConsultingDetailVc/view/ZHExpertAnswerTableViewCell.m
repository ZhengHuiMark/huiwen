...
@interface ZHExpertAnswerTableViewCell()
...
@implementation ZHExpertAnswerTableViewCell
...
-(void)setDetailModel:(ZHAllMyDetailModel *)detailModel{
    ...
    self.content.text = self.detailModel.answerContent;
                self.askTime.text = self.detailModel.answerTime;
    
                NSArray *PhotoArray = [self.detailModel.answerPhotos componentsSeparatedByString:@","];
