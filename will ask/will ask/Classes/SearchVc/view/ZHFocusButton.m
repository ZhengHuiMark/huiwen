...
@implementation ZHFocusButton
#pragma mark - Constructor
+ (instancetype)buttonWithTitle:(NSString *)title origin:(CGPoint)origin inView:(UIView *)superView {
    
    ZHFocusButton *button = [[[NSBundle mainBundle] loadNibNamed: NSStringFromClass([self class])
                                                     owner: nil
...
- (IBAction)buttonAction:(UIButton *)sender {
    ...
    !self.buttonAction?:self.buttonAction(self);
}
