//
//  ZHMoreFreeListViewController.m
//  will ask
//
...
@interface ZHMoreFreeListViewController ()<UITableViewDelegate,UITableViewDataSource>

@property(nonatomic,strong)UITableView *tableView;

@property(nonatomic,strong)NSMutableArray <ZHMoreFreeListModel *>*mListModels;

@end

@implementation ZHMoreFreeListViewController
...
- (void)loadData {
    ...
    [[ZHNetworkTools sharedTools]requestWithType:GET andUrl:url andParams:dic andCallBlock:^(id response, NSError *error) {
        ...
        NSArray <ZHMoreFreeListModel *>*models = [NSArray yy_modelArrayWithClass:[ZHMoreFreeListModel class] json:response[@"data"]];
...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    ZHMoreFreeListModel *model = _mListModels[indexPath.row];
